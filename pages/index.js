...
export default function TeacherTablet() {
    ...
    const handleSendIndice = (client) => {
        setClient(client);
        socket.emit("professeurClic", client);
    };
    ...
    return (
        <>
            ...
            <button onClick={() => handleSendIndice('client1')}>Envoyer indice au client 1</button>
            <button onClick={() => handleSendIndice('client2')}>Envoyer indice au client 2</button>
        </>
    );
};
